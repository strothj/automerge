...
const { OBJECT_ID, CONFLICTS, DEFAULT_V, ELEM_IDS, MAX_ELEM } = require('./constants')
...
function cloneMapObject(originalObject, objectId) {
  ...
  const conflicts = Object.assign({}, originalObject ? originalObject[CONFLICTS] : undefined)
  const defaultV  = Object.assign({}, originalObject ? originalObject[DEFAULT_V] : undefined)
